...
- `fetch_swap_markets(self, params: Any = {})`
...
- `get_margin_mode(self, trigger: Any, params: Any)`
- `get_settlement_currencies(self, type: Any, method: Any)`
- `modify_margin_helper(self, symbol: str, amount: Any, params={})`
- `multi_order_spot_prepare_request(self, market: Market = None, trigger: Bool = False, params: dict = {})`
- `nonce(self)`
- `prepare_orders_by_status_request(self, status: Any, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `load_positions_snapshot(self, client: Client, messageHash: Any, type: Any)`
...
- `get_url_by_market(self, market: Any)`
...
- `subscribe_public(self, url: Any, messageHash: Any, payload: Any, channel: Any, params={}, subscription: dict | None = None)`
- `subscribe_public_multiple(self, url: Any, messageHashes: Any, payload: Any, channel: Any, params={})`
- `un_subscribe_public_multiple(self, url: Any, topic: Any, symbols: Any, messageHashes: Any, subMessageHashes: Any, payload: Any, channel: Any, params={})`
- `authenticate(self, url: Any, messageType: Any)`
- `subscribe_private(self, url: Any, messageHash: Any, payload: Any, channel: Any, params: Any, requiresUid=False)`
