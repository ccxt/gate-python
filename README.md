...
- `fetch_swap_markets(self, params: object = {})`
...
- `get_margin_mode(self, trigger: object, params: object)`
- `get_settlement_currencies(self, type: object, method: object)`
- `modify_margin_helper(self, symbol: str, amount: object, params={})`
- `multi_order_spot_prepare_request(self, market: Market = None, trigger: Bool = False, params: dict = {})`
- `nonce(self)`
- `prepare_orders_by_status_request(self, status: object, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `load_positions_snapshot(self, client: Client, messageHash: object, type: object)`
...
- `get_url_by_market_type(self, type: Str, isInverse=False)`
- `get_market_type_by_url(self, url: str)`
- `subscribe_public(self, url: object, messageHash: object, payload: object, channel: object, params={}, subscription: dict | None = None)`
- `subscribe_public_multiple(self, url: object, messageHashes: object, payload: object, channel: object, params={})`
- `un_subscribe_public_multiple(self, url: object, topic: object, symbols: object, messageHashes: object, subMessageHashes: object, payload: object, channel: object, params={})`
- `authenticate(self, url: object, messageType: object)`
- `subscribe_private(self, url: object, messageHash: object, payload: object, channel: object, params: object, requiresUid=False)`
