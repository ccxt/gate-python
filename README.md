...
- `create_orders_request(self, orders: list[OrderRequest], params: dict = {})`
...
- `fetch_leverages(self, symbols: Strings = None, params: dict = {})`
- `fetch_liquidations(self, symbol: str, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_network_deposit_address(self, code: str, params: dict = {})`
...
- `fetch_option_markets(self, params: dict = {})`
- `fetch_option_ohlcv(self, symbol: str, timeframe: Str = '1m', since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_order_request(self, id: str, symbol: Str = None, params: dict = {})`
...
- `fetch_spot_markets(self, params: dict = {})`
- `fetch_swap_markets(self, params: dict = {})`
...
- `fetch_transaction_fees(self, codes: Strings = None, params: dict = {})`
...
- `describe(self)`
- `edit_order_request(self, id: str, symbol: Str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params: dict = {})`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params: dict = {})`
- `get_margin_mode(self, trigger: Bool, params: dict)`
- `get_settlement_currencies(self, type: Str, method: Str)`
- `modify_margin_helper(self, symbol: str, amount: Num, params: dict = {})`
- `multi_order_spot_prepare_request(self, market: Market = None, trigger: Bool = False, params: dict = {})`
- `nonce(self)`
- `prepare_orders_by_status_request(self, status: Str, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `prepare_request(self, market: Market = None, type: Str = None, params: dict = {})`
...
- `spot_order_prepare_request(self, market: Market = None, trigger: Bool = False, params: dict = {})`
...
- `public_futures_get_settle_adl_risk_states(request)`
- `public_futures_post_settle_funding_rates(request)`
...
- `public_earn_get_dual_project_recommend(request)`
- `public_earn_get_fixed_term_product(request)`
- `public_earn_get_fixed_term_product_asset_list(request)`
...
- `private_wallet_get_transfers(request)`
...
- `private_unified_get_delta_neutral(request)`
- `private_unified_get_estimated_quick_repayment(request)`
...
- `private_unified_post_delta_neutral(request)`
- `private_unified_post_leverage_user_setting(request)`
- `private_unified_post_quick_repayment(request)`
...
- `private_spot_get_pov_orders(request)`
- `private_spot_get_pov_orders_order_id(request)`
...
- `private_spot_post_pov_orders(request)`
...
- `private_spot_delete_pov_orders(request)`
- `private_spot_delete_pov_orders_order_id(request)`
...
- `private_futures_get_settle_autoorder_v1_trail_list(request)`
- `private_futures_get_settle_autoorder_v1_trail_detail(request)`
- `private_futures_get_settle_autoorder_v1_trail_change_log(request)`
- `private_futures_get_settle_autoorder_v1_chase_list(request)`
- `private_futures_get_settle_autoorder_v1_chase_detail(request)`
...
- `private_futures_post_settle_autoorder_v1_trail_create(request)`
- `private_futures_post_settle_autoorder_v1_trail_stop(request)`
- `private_futures_post_settle_autoorder_v1_trail_stop_all(request)`
- `private_futures_post_settle_autoorder_v1_trail_update(request)`
- `private_futures_post_settle_autoorder_v1_chase_create(request)`
- `private_futures_post_settle_autoorder_v1_chase_stop(request)`
- `private_futures_post_settle_autoorder_v1_chase_stop_all(request)`
...
- `private_options_put_orders_order_id(request)`
...
- `private_earn_get_dual_order_refund_preview(request)`
- `private_earn_get_fixed_term_user_lend(request)`
- `private_earn_get_fixed_term_user_history(request)`
- `private_earn_get_autoinvest_coins(request)`
- `private_earn_get_autoinvest_config(request)`
- `private_earn_get_autoinvest_orders(request)`
- `private_earn_get_autoinvest_plans_detail(request)`
- `private_earn_get_autoinvest_plans_list_info(request)`
- `private_earn_get_autoinvest_plans_records(request)`
...
- `private_earn_post_dual_order_refund(request)`
- `private_earn_post_dual_modify_order_reinvest(request)`
- `private_earn_post_fixed_term_user_lend(request)`
- `private_earn_post_fixed_term_user_pre_redeem(request)`
- `private_earn_post_autoinvest_min_invest_amount(request)`
- `private_earn_post_autoinvest_plans_add_position(request)`
- `private_earn_post_autoinvest_plans_create(request)`
- `private_earn_post_autoinvest_plans_stop(request)`
- `private_earn_post_autoinvest_plans_update(request)`
...
- `private_rebate_get_partner_data_aggregated(request)`
...
- `private_otc_get_bank_list(request)`
- `private_otc_get_bank_bank_supplement_checklist(request)`
...
- `private_otc_post_bank_create(request)`
- `private_otc_post_bank_delete(request)`
- `private_otc_post_bank_set_default(request)`
- `private_otc_post_bank_personal_bank_supplement(request)`
- `private_otc_post_bank_enterprise_bank_supplement(request)`
- `private_otc_post_upload_pre_upload(request)`
...
- `create_orders_ws(self, orders: list[OrderRequest], params: dict = {})`
...
- `fetch_order_ws(self, id: str, symbol: Str = None, params: dict = {})`
- `fetch_open_orders_ws(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_closed_orders_ws(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_orders_by_status_ws(self, status: str, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `subscribe_watch_tickers_and_bids_asks(self, symbols: Strings = None, callerMethodName: Str = None, params: dict = {})`
...
- `load_positions_snapshot(self, client: Client, messageHash: str, type: object)`
- `watch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `watch_my_liquidations(self, symbol: str, since: Int = None, limit: Int = None, params: dict = {})`
- `watch_my_liquidations_for_symbols(self, symbols: list[str], since: Int = None, limit: Int = None, params: dict = {})`
- `get_url_by_market(self, market: object)`
- `get_type_by_market(self, market: Market)`
- `get_url_by_market_type(self, type: Str, isInverse: Bool = False)`
- `get_market_type_by_url(self, url: str)`
- `subscribe_public(self, url: Str, messageHash: str, payload: list[object], channel: Str, params: dict = {}, subscription: dict | None = None)`
- `subscribe_public_multiple(self, url: Str, messageHashes: list[str], payload: list[object], channel: Str, params: dict = {})`
- `un_subscribe_public_multiple(self, url: Str, topic: str, symbols: list[str], messageHashes: list[str], subMessageHashes: list[str], payload: object, channel: Str, params: dict = {})`
- `authenticate(self, url: Str, messageType: Str)`
- `subscribe_private(self, url: Str, messageHash: str, payload: object, channel: Str, params: dict, requiresUid: Bool = False)`
